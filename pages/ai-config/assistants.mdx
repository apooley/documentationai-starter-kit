...
<Card
  ...
  icon="book-open"
  cta="Define behavior, tone, and constraints"
  horizontal="true"
>

Manage Playbooks on `/playbooks` to define identity, tone, goals, constraints, safety, channels, tools, model, and context that assistants can execute at runtime.
