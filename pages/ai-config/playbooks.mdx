...
The Primary Goal describes what the assistant is trying to achieve. This is a multi-line field, allowing you to break down complex goals into readable paragraphs or bullet points. 

For example:
```text
Determine if the user is a qualified buyer.
- Collect their name, company, and email address.
- Ask about their current software stack.
- Find out their timeline for implementation.
```
