...
- **Qualification Data** — Real-time qualification fields extracted by the AI (e.g., Budget, Timeline) based on your Qualification Settings criteria

## Delivery & Sync History

Below the transcript on the left side, you'll find the **Delivery & Sync** panel. This panel shows the complete history of CRM syncs and lead notifications for the conversation.

Expand the panel to see a chronological log of:
- **CRM Syncs** (e.g., Dynamics 365, Salesforce)
- **Structured XML Emails** (ADF lead delivery)
- **Email & SMS Notifications**
- **Webhook deliveries**

If a delivery fails, the status badge will turn red and you can see the error details in the table. The right sidebar also displays a quick summary of the latest delivery status (e.g., "CRM: Delivered · Notifications: Delivered").
...
For chat conversations handled by the AI, you'll see a **Review** button at the top of the thread. This opens the Training Review modal — an AI-guided debrief of how the assistant performed.

The Training Review will analyze the conversation and suggest improvements to your playbook or assistant instructions. If you agree with the suggestions, you can apply them with a single click. This creates a continuous feedback loop where your AI gets smarter with every conversation.

## Snoozing and resolving
